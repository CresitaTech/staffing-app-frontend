...
@Component({
  selector: 'app-email-temp-inline',
  template: `
    <div class="form-row">
...
export class EmailTempInlineComponent extends Paging<EmailTemplate> {
  ...
  openCreateModal(): void {
    const modalRef = this.modalService.open(AddEmailTempComponent, {
      backdrop:'static',
      keyboard: false,
      size: 'lg'
    });
