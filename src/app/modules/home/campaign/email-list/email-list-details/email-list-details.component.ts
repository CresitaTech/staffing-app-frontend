...
@Component({
  selector: 'app-email-list-details',
  templateUrl: './email-list-details.component.html',
  styleUrls: ['./email-list-details.component.scss']
})
export class EmailListDetailsComponent extends CustomFilterModel<EmailList> implements OnInit, OnDestroy, CustomFilterInterface {

  api_path = APIPath.EMAIL_LIST_DETAILS;
  ...
  ngOnChanges() {
    ...
    if (this.routerURL === "email-list-details") {
      this.myActionFlag = 'email-list-details';
      console.log(this.routerURL)
      var url = this.api_path + "?list_id=" + this.listId;
      console.log(url)
