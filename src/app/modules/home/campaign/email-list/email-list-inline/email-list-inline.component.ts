...
import { CreateEmailCampaignComponent } from 'src/app/modules/home/campaign/create-email-campaign/create-email-campaign.component';

@Component({
  selector: 'app-email-list-inline',
  template: `
    <div class="form-row">
      <div class="col form-group">
        <label class="asterisk-if-mandatory">List Name</label>
        <div class="form-row">
          <div class="col">
            <ng-select #select  [items]="collection" [searchable]="false" [(ngModel)]="item" (ngModelChange)="change($event);" 
            bindLabel="list_name" bindValue="id" required  name = "_item" 
...
export class EmailListInlineComponent extends Paging<EmailList> {
  ...
  constructor(
    _api: APIProviderService<EmailList>,
  ...
  openCreateModal(): void {
    const modalRef = this.modalService.open(CreateEmailCampaignComponent, {
      backdrop:'static',
      keyboard: false,
      size: 'lg'
    });
