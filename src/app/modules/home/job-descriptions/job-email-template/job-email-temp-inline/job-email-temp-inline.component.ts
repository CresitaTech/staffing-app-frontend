...
@Component({
  selector: 'app-job-email-temp-inline',
  template: `
    <div class="form-row">
      <div class="col form-group">
        ...
        <div class="form-row">
          <div class="col">
            ...
            bindLabel="template_name" bindValue="id" required  name = "_item" 
...
export class JobEmailTempInlineComponent extends Paging<EmailTemplate> {
  ...
  openCreateModal(): void {
    const modalRef = this.modalService.open(AddJobEmailTempComponent, {
      backdrop:'static',
      keyboard: false,
      size: 'lg'
    });
