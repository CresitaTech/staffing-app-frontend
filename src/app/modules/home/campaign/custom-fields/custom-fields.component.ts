...
export class CustomFieldsComponent extends CustomFilterModel<EmailList> implements OnInit, OnDestroy, CustomFilterInterface {
  ...
  doAction() {
    ...
    var modalRef = this.modalService.open(AddCustomFieldsComponent, {
      backdrop: 'static',
      centered: true,
      keyboard: false,
    });
