...
@Component({
  selector: 'app-job-email-template',
  templateUrl: './job-email-template.component.html',
  styleUrls: ['./job-email-template.component.scss']
})
export class JobEmailTemplateComponent extends Paging<EmailTemplate> {
